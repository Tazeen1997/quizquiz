const qBank = [
  ...
  {
    question: 
    "What's the name of Batman's  parents?",
    answers: [
      "Thomas & Martha",
      "Joey & Jackie",
      "Jason & Sarah",
  ...
  },
  {
    ...
    answers: ["Tight Rope", "Broken Glass", "Balls", "Moon"],
  ...
  },
  {
    ...
    answers: ["Skin", "Heart", "Intestine", "Liver"],
    correct: "Skin",
    questionId: "1436873"
  },
  {
  ...
  {
    question: "Which is the continuously World’s oldest Democracy?",
    answers: [
      "UK",
      "US",
      "India",
  ...
  },
  {
    ...
    answers: ["Dance", "Medical procedure", "Sport", "Language"],
    correct: "A dance",
    questionId: "2019778"
  },
  {
    question: "What is the name of the Jewish New Year?",
    answers: ["Rosh Hashanah", "Elul", "Noun", "Succoss"],
    correct: "Rosh Hashanah",
    questionId: "2134343"
  },
  {
    question: "Which Country first used pepper?",
    answers: [
      "Greece",
      "India",
      "China",
